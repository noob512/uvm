...
#undef NV_DRM_DRM_APERTURE_H_PRESENT
...
#define NV_DRM_DRM_EDID_H_PRESENT
#undef NV_DRM_DRM_FBDEV_GENERIC_H_PRESENT
#define NV_DRM_DRM_FBDEV_TTM_H_PRESENT
#define NV_DRM_DRM_CLIENT_SETUP_H_PRESENT
...
#define NV_DRM_DRM_PROPERTY_H_PRESENT
...
#undef NV_SOC_TEGRA_FUSE_HELPER_H_PRESENT
