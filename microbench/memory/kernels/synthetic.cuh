...
// Uses PTX prefetch.global.L2 instruction to prefetch pages ahead of actual access
// This should trigger page faults for UVM pages on CPU, causing migration
